...
public class question2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        B1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(str.equals("a droite")){
                    score+=20;
                    startActivity(new Intent(question2.this,question3.class).putExtra("score",score), options.toBundle());
                    CDT.cancel();
                }
                startActivity(new Intent(question2.this,question3.class).putExtra("score",score), options.toBundle());
                CDT.cancel();
    ...
    public void onBackPressed() {
        Toast.makeText(question2.this, "Impossible to go back.",
    ...
    private void speak() {
        ...
        mTTS.speak(convText+"   réponse numéro 1    a droite ,   réponse numéro 2    a gauche",TextToSpeech.QUEUE_FLUSH,null,null);
    }
}