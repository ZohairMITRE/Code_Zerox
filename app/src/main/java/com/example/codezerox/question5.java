...
public class question5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CountDownTimer CDT = new CountDownTimer(15000, 1000) {
            ...
            public void onFinish() {
                startActivity(new Intent(question5.this,My_score.class));
            }
        }.start();
        //------------------------------------------
        ...
        B1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(str.equals("Non")){
                    score+=20;
                    startActivity(new Intent(question5.this,My_score.class).putExtra("score",score), options.toBundle());
                    CDT.cancel();
                }
                startActivity(new Intent(question5.this,My_score.class).putExtra("score",score), options.toBundle());
                CDT.cancel();
    ...
    public void onBackPressed() {
        Toast.makeText(question5.this, "Impossible to go back.",
